...
| Cinemachine | `6.6.0` | 2D camera follow, framing, shake, and transitions |
| 2D Animation | `16.0.0` | Bone-based 2D characters and sprite skinning |
| 2D SpriteShape | `16.0.0` | Procedural 2D paths and terrain |
| 2D Tilemap Extras | `9.0.0` | Rule Tiles, brushes, and tilemap authoring helpers |
| Addressables | `2.11.2` | Async content loading and remote content |
| Localization | `1.5.13` | Runtime language support |
| Test Framework | `1.8.0` | EditMode and PlayMode tests |
...
| Cinemachine | `6.6.0` | 2D kamera takip, kadraj, sarsıntı ve geçişler |
| 2D Animation | `16.0.0` | Kemik tabanlı 2D karakter ve sprite skinning |
| 2D SpriteShape | `16.0.0` | Prosedürel 2D yol ve arazi |
| 2D Tilemap Extras | `9.0.0` | Rule Tile, brush ve tilemap araçları |
| Addressables | `2.11.2` | Asenkron ve uzak içerik yükleme |
| Localization | `1.5.13` | Çalışma zamanı dil desteği |
| Test Framework | `1.8.0` | EditMode ve PlayMode testleri |
